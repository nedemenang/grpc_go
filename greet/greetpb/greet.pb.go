...
type GreetEveryoneRquest struct {
	Greeting             *Greeting `protobuf:"bytes,1,opt,name=greeting,proto3" json:"greeting,omitempty"`
	XXX_NoUnkeyedLiteral struct{}  `json:"-"`
	XXX_unrecognized     []byte    `json:"-"`
	XXX_sizecache        int32     `json:"-"`
...
func (m *GreetEveryoneRquest) Reset()         { *m = GreetEveryoneRquest{} }
func (m *GreetEveryoneRquest) String() string { return proto.CompactTextString(m) }
func (*GreetEveryoneRquest) ProtoMessage()    {}
func (*GreetEveryoneRquest) Descriptor() ([]byte, []int) {
	return fileDescriptor_fe6f881da19a2871, []int{7}
}

func (m *GreetEveryoneRquest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_GreetEveryoneRquest.Unmarshal(m, b)
}
func (m *GreetEveryoneRquest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_GreetEveryoneRquest.Marshal(b, m, deterministic)
}
func (m *GreetEveryoneRquest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GreetEveryoneRquest.Merge(m, src)
}
func (m *GreetEveryoneRquest) XXX_Size() int {
	return xxx_messageInfo_GreetEveryoneRquest.Size(m)
}
func (m *GreetEveryoneRquest) XXX_DiscardUnknown() {
	xxx_messageInfo_GreetEveryoneRquest.DiscardUnknown(m)
}

var xxx_messageInfo_GreetEveryoneRquest proto.InternalMessageInfo

func (m *GreetEveryoneRquest) GetGreeting() *Greeting {
	if m != nil {
		return m.Greeting
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*GreetEveryoneRquest)(nil), "greet.GreetEveryoneRquest")
...
var fileDescriptor_fe6f881da19a2871 = []byte{
	...
	,
}
...
type GreetService_GreetEveryoneClient interface {
	Send(*GreetEveryoneRquest) error
...
func (x *greetServiceGreetEveryoneClient) Send(m *GreetEveryoneRquest) error {
	return x.ClientStream.SendMsg(m)
}
...
type GreetService_GreetEveryoneServer interface {
	...
	Recv() (*GreetEveryoneRquest, error)
	grpc.ServerStream
}
...
func (x *greetServiceGreetEveryoneServer) Recv() (*GreetEveryoneRquest, error) {
	m := new(GreetEveryoneRquest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
